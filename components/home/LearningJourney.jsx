      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <div className="mb-7 flex items-end justify-between gap-4">
            ...
            <Link
              href="/learn"
              className="hidden items-center gap-1 text-xs font-bold text-[var(--av-brand)] sm:flex"
            >
              ورود به مسیر
                ...
                <Link href={step.href} className="block h-full">
                  ...
                  >
                    <div className="mb-8 flex items-center justify-between">
                      <span className="text-[10px] font-black text-[var(--av-brand)]">
                        {step.num}
                      </span>
                    ...
                    <h3 className="text-sm font-extrabold text-[var(--av-text)]">
                      {step.title}
                    </h3>

                    <p className="mt-1 text-[10px] leading-6 text-[var(--av-text-muted)] sm:text-xs">
                      {step.desc}
                    </p>

                    <span className="absolute -bottom-6 -left-4 text-7xl font-black text-[var(--av-text)]/[0.025] transition-transform duration-500 group-hover:-translate-y-2">
                      {step.num}
                    </span>
                  </motion.div>
                </Link>
